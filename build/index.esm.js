...
var Button = function (_a) {
    ...
    return (jsxs("button", __assign({ type: "button", "data-testid": "button", disabled: disabled, className: classnames("button", "btn--".concat(kind), "btn--".concat(size)) }, { children: [iconLeft, children] })));
};
